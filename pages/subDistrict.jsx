    ...
    <div className="row align-items-center">
      <div className="border-0 mb-4">
        <div className="row text-center  py-2 no-bg bg-transparent d-flex align-items-center text-underline">
          <h3 className="fw-bold mb-0 dashboardheader">Sub-District Details</h3>
        </div>
      ...
      <div className="col-xl-12 col-lg-12 col-md-12">
        <div className="card">
          <div className="card-header py-3 d-flex justify-content-between border-bottom">
            <h6 className="mb-0 fw-bold">Sub-District Details</h6>
          </div>
                  ...
                  >
                    <thead>
                      <tr role="row">
                        ...
                        <th
                          ...
                          colSpan={1}
                          style={{ width: 375 }}
                          aria-label="District Name: activate to sort column ascending"
                        >
                          District Name
                        </th>
                        <th
                          ...
                          colSpan={1}
                          style={{ width: 363 }}
                          aria-label="Sub District Name : activate to sort column ascending"
                        >
                          Sub District Name{" "}
                        </th>
                        <th
                    ...
                    <tbody className="mb-4">
                      <tr role="row" className="odd">
                        ...
                        <td>fgdhfghdf gfhdfghdfhdfgdhfhdfd</td>
                        <td>ghgdsf gfhdgfdfg fghdfghdfghdd</td>
                        <td>ghgdsf gfhdgfdfg fghdfghdfghdd</td>
                        <td>fddh gfhdgf ghdfghdf dfgfhgdfs</td>
                        <td className="btn-group" role="group">
                          <Link
                            className="edit btn btn-outline-secondary"
                            style={{ display: "inline" }}
                            href="/editSubDistrict"
                          >
                            <i
