    ...
    <div className="row align-items-center">
      <div className="border-0 mb-4">
        <div className="row text-center py-2 no-bg bg-transparent d-flex align-items-center text-underline">
          <h3 className="fw-bold mb-0 dashboardheader">Mineral Details</h3>
        </div>
      ...
      <div className="col-xl-12 col-lg-12 col-md-12">
        <div className="card">
          <div className="card-header py-3 d-flex justify-content-between border-bottom">
            <h6 className="mb-0 fw-bold">Mineral Details</h6>
          </div>
                  ...
                  >
                    <thead>
                      <tr role="row">
                        ...
                        <th
                          ...
                          colSpan={1}
                          style={{ width: 324 }}
                          aria-label="Mineral Name: activate to sort column ascending"
                        >
                          Mineral Name
                        </th>
                        <th
                          ...
                          colSpan={1}
                          style={{ width: 300 }}
                          aria-label="ATR Name: activate to sort column ascending"
                        >
                          ATR Name
                        </th>
                        <th
                          ...
                          colSpan={1}
                          style={{ width: 186 }}
                          aria-label="HSN Code: activate to sort column ascending"
                        >
                          HSN Code
                        </th>
                        <th
                    ...
                    <tbody>
                      <tr role="row" className="odd">
                        ...
                        <td>gsdf fdgs fdgs fdgsfdsd fsdgfs</td>
                        <td>dghsd ssdgshfdgsd sfdgsdfgsdf</td>
                        <td>sdgfsd sdfgsfdgdf dgsfdgsdfgfd</td>
                        <td>5555656565565656</td>
                        <td className="d-flex">
                          <div className="btn-group" role="group">
                            <a
                              className="edit btn btn-outline-secondary"
                              style={{ display: "inline" }}
                              href="http://mines-manager.com/minerals/9/edit"
                            >
                              <i
                            ...
                            <form
                              action="http://mines-manager.com/minerals/9"
                              method="Post"
                            >
                              <input
                                type="hidden"
