...
const AddCountry = () => {
  ...
  const isValidCountryName = (countryName) => /^[a-zA-Z ]*$/.test(countryName);
...
{isAlertVisible && (
        <Modal show={isAlertVisible} onHide={() => setIsAlertVisible(false)} centered backdrop="static" keyboard={false}>
          <Modal.Header style={{ backgroundColor: '#113c62', color: 'white', paddingBottom: '0' }}>
            <Modal.Title>Country Status</Modal.Title>
            <p></p>
          </Modal.Header>
          <Modal.Body>
            <p></p>
          ...
          <Modal.Footer style={{ paddingTop: '0' }}>
            <Button variant="primary" onClick={handleAlertOkClick} style={{ backgroundColor: 'white', color: '#113c62' }}>
              OK
            </Button>
          </Modal.Footer>
        </Modal>
