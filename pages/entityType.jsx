  ...
  <div className="container-fluid">
    <div className="row align-items-center">
      <div className="row text-center py-2 no-bg bg-transparent d-flex align-items-center text-underline">
        <h3 className="fw-bold mb-0 dashboardheader">Entity Details</h3>
      </div>
    ...
    <div className="row g-3 mb-3">
      <div className="col-xl-12 col-lg-12 col-md-12">
        <div className="card">
          <div className="card-header py-3 d-flex justify-content-between border-bottom"></div>
                  ...
                  >
                    <thead>
                      <tr role="row">
                        ...
                        <th
                          ...
                          colSpan={1}
                          style={{ width: 779 }}
                          aria-label="Type Of Entity: activate to sort column ascending"
                        >
                          Type Of Entity
                        </th>
                        <th
                    ...
                    <tbody>
                      <tr role="row" className="odd">
                        ...
                        <td>
                          dsf dsff fdff ffgf fdgsfd ioo disud dyswusue yuwye
                        </td>
                        <td>dsd ydusyus ydusydu</td>
                        <td className="d-flex">
                          <a
                            className="edit btn btn-outline-secondary"
                            style={{ display: "inline" }}
                            href="http://mines-manager.com/EntityType/15/edit"
                          >
                            <i
                          ...
                          <form
                            action="http://mines-manager.com/EntityType/15"
                            method="Post"
                          >
                            <input
                              type="hidden"
