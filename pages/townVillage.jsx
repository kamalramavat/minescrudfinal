      ...
      <div className="col-xl-12 col-lg-12 col-md-12">
        <div className="card">
          <div className="card-header py-3 d-flex justify-content-between border-bottom">
            <h6 className="mb-0 fw-bold">Town / Village Details</h6>
          </div>
                    ...
                    <thead>
                      <tr role="row">
                        ...
                        <th
                          ...
                          colSpan={1}
                          style={{ width: 275 }}
                          aria-label="Town / Village Name: activate to sort column ascending"
                        >
                          Town / Village Name
                        </th>
                        <th
                    ...
                    <tbody className="mb-4">
                      <tr role="row" className="odd">
                        ...
                        <td className="btn-group" role="group">
                          ...
                          <form
                            action="http://mines-manager.com/Village/23"
                            method="POST"
                          >
                            <input
                              type="hidden"
